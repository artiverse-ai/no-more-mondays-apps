    ...
    <main className="mx-auto w-full max-w-[1500px] space-y-6 p-6 md:p-10">
      <header className="space-y-2 border-b border-border pb-6">
        ...
        <p className="max-w-3xl text-sm text-muted-foreground">
          Find Calendly bookings by funnel (the event-type&apos;s
          <code className="mx-1 rounded bg-muted px-1.5 py-0.5 text-xs">internal_note</code>
          tag). Funnels are pulled from every active event type across the
          org, then we query scheduled events org-wide and filter locally.
          Host is read from
